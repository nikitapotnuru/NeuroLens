...
export default function LandingPage() {
  return (
    <div className="flex flex-col items-center w-full font-sans">
      ...
      <section className="w-full bg-gradient-to-b from-orange-50 via-rose-50 to-white py-24 px-6 text-center flex flex-col items-center justify-center min-h-[70vh]">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center w-full sm:w-auto">
            <Link to="/register" className="bg-nl-primaryTeal text-white px-10 py-4 rounded-full font-bold shadow-lg hover:shadow-2xl hover:-translate-y-1 hover:bg-teal-500 transition-all duration-300 text-lg w-full sm:w-auto">
              Start Screening Now
            </Link>
            <a href="#how-it-works" className="bg-white text-nl-darkText border-2 border-transparent hover:border-orange-100 px-10 py-4 rounded-full font-bold shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-lg w-full sm:w-auto">
              Learn How It Works
            </a>
          </div>
        </div>
      ...
      {/* ✨ FEATURES SECTION (Centered & Interactive) */}
